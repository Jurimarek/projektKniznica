    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">Autori <a href="<?php echo
                    site_url('temperatures/add/'); ?>" class="glyphicon glyphicon-plus pullright"
                    ></a></div>
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th width="5%">ID</th>
                        <th width="30%">Prievisko_autora</th>
...
glyphicon-edit"></a>
                                <a href="<?php echo
                                site_url('temperatures/delete/'.$temperature['id']); ?>" class="glyphicon
